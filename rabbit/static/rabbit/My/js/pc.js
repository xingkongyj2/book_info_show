     // $(function(){
        ...
        // });
			...
			myfunction($(".bar .menu .ulmenu1 li"),$(".bar .ulmenu1 li a"),$(".bar .content .menu1 .tab"));
			myfunction($(".bar .menu .ulmenu2 li"),$(".bar .ulmenu2 li a"),$(".bar .content .menu2 .tab"));
			myfunction($(".bar .menu .ulmenu3 li"),$(".bar .ulmenu3 li a"),$(".bar .content .menu3 .tab"));
			...
			$(function(){            //ul/li的折叠效果
				$(".menu > ul").eq(0).show();
				 $(".menu h3").click(function(){
				 		...
				 		$(".bar .content .menu"+menu_value+" .tab:first-child").addClass("active");
				 		$(".bar .menu .ulmenu"+menu_value+" li>a").removeClass("selected");
				 		$(".bar .menu .ulmenu"+menu_value+" li a").eq(0).addClass("selected");//默认设置为被选中状态
			...
			$(function(){   // 导航 >
				 $(".bar .menu > h3").click(function(){

				 	$(".bar .content .A1").empty().text($(this).text());
